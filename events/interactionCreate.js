...
client.on("interactionCreate", async (interaction) => {
  try {
    ...
    if (interaction.isCommand()) {
      ...
      let prefix = "/"; // You may set the prefix here
      ...
      // Check user and bot permissions, and cooldown before executing the command
    ...
    console.error("Error while processing interaction:", error);
